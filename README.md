# Dependency Graph Visualizer - Stage 3

## 📋 Описание

CLI-приложение для визуализации графа зависимостей NPM пакетов. **Этап 3** реализует вывод в формате ASCII-дерева и поддерживает любую глубину поиска зависимостей.
